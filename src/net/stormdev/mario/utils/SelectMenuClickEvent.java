...
public class SelectMenuClickEvent extends Event implements Cancellable{
	...
	public SelectMenuClickEvent(IconMenu.OptionClickEvent clickEvent, SelectMenuType type, int absolutePageNumber) {
		this.clickEvent = clickEvent;
		this.page = absolutePageNumber;
		this.type = type;
	}
	public SelectMenuClickEvent(IconMenu.OptionClickEvent clickEvent, SelectMenuType type, int absolutePageNumber, Object[] args) {
		this.clickEvent = clickEvent;
		this.page = absolutePageNumber;
		this.type = type;
		this.args = args;
