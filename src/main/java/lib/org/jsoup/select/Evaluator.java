package lib.org.jsoup.select;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import lib.org.jsoup.helper.Validate;
import lib.org.jsoup.nodes.Comment;
import lib.org.jsoup.nodes.Document;
import lib.org.jsoup.nodes.DocumentType;
import lib.org.jsoup.nodes.Element;
import lib.org.jsoup.nodes.Node;
import lib.org.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<lib.org.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (lib.org.jsoup.nodes.Attribute attribute : values) {
