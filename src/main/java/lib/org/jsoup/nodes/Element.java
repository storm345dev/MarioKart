package lib.org.jsoup.nodes;

import java.util.*;
import java.util.regex.Pattern;
import java.util.regex.PatternSyntaxException;

import lib.org.jsoup.helper.StringUtil;
import lib.org.jsoup.helper.Validate;
import lib.org.jsoup.parser.Parser;
import lib.org.jsoup.parser.Tag;
import lib.org.jsoup.select.*;
...
public class Element extends Node {
     ...
     * </ul>
     * <p/>
     * See the query syntax documentation in {@link lib.org.jsoup.select.Selector}.
     *
     * @param cssQuery a {@link Selector} CSS-like query
     * @return elements that match the query (empty if none match)
     * @see lib.org.jsoup.select.Selector
     */
